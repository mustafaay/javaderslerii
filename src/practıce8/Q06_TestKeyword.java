...
*/
    ...
    public static void main(String[] args) {
        ...
        cevapanahtari(answers, keys);


    }

    public static void cevapanahtari(char[][] answers, char[] keys) {
        ...
        for (int i = 0; i < answers.length; i++) {
            ...
            System.out.println((i + 1) + " . ogrencinin   10 tane soruda   " + dogrucevapsayisi + " tane dogru cevabi var");
